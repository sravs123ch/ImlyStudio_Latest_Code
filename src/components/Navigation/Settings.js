...
// import "react-toastify/dist/ReactToastify.css";
// import LoadingAnimation from "../Loading/LoadingAnimation";
// import { createTenantSettings,updateTenantSettings } from "../../Constants/apiRoutes";
// import { useParams } from "react-router-dom";
// import { RiCloseLine } from "react-icons/ri";
// import { FiUpload } from "react-icons/fi";
// import { FcImageFile } from "react-icons/fc";
...
useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${updateTenantSettings}/${tenantID}`, formPayload, {
      ...
      <div className="mt-6 p-6 bg-white">
        ...
        {/* <div className="mb-4 flex items-start">
          ...
          <div className="w-1/3">
            <label
              htmlFor="project-image-upload"
              className="border-dashed border-2 border-gray-300 p-4 rounded-lg flex items-center justify-center cursor-pointer"
            >
              {formData.imagePreview ? (
                <img src={formData.imagePreview} alt="Preview" className="w-16 h-16 object-cover" />
              ) : (
                <FaRegFileImage size={30} className="text-gray-400 mb-2" />
              )}
            </label>
